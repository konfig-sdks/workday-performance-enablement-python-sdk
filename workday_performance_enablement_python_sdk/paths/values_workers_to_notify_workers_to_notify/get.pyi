...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    'RequestOptionalQueryParams',
    {
        ...
        'workers': typing.Union[WorkersSchema, list, tuple, ],
    },
    total=False
)
...
request_query_workers = api_client.QueryParameter(
    name="workers",
    style=api_client.ParameterStyle.FORM,
...
class BaseApi(api_client.Api):
    ...
    def _get_instances_mapped_args(
        self,
        limit: typing.Optional[int] = None,
        offset: typing.Optional[int] = None,
        workers: typing.Optional[typing.List[str]] = None,
        ...
        if workers is not None:
            _query_params["workers"] = workers
        args.query = _query_params
        return args

    async def _aget_instances_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/values/workersToNotify/workersToNotify',
            headers=_headers,
        )
...
class GetInstancesRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_instances(
        self,
        limit: typing.Optional[int] = None,
        offset: typing.Optional[int] = None,
        workers: typing.Optional[typing.List[str]] = None,
        **kwargs,
        ...
        args = self._get_instances_mapped_args(
            limit=limit,
            offset=offset,
            workers=workers,
        )
        return await self._aget_instances_oapg(
    ...
    def get_instances(
        ...
        return self._get_instances_oapg(
            query_params=args.query,
        )
...
class GetInstances(BaseApi):
    ...
    async def aget_instances(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_instances(
            limit=limit,
            offset=offset,
            workers=workers,
            **kwargs,
    ...
    def get_instances(
        ...
        raw_response = self.raw.get_instances(
            limit=limit,
            offset=offset,
            workers=workers,
        )
