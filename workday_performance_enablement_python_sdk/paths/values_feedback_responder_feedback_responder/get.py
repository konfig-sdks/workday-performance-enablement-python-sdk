...
class BaseApi(api_client.Api):
    ...
    def _get_instances_2_mapped_args(
        self,
    ...
    async def _aget_instances_2_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/values/feedbackResponder/feedbackResponder',
            headers=_headers,
        )
...
class GetInstances2Raw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_instances_2(
        self,
        limit: typing.Optional[int] = None,
        offset: typing.Optional[int] = None,
        template_type: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._get_instances_2_mapped_args(
            limit=limit,
            offset=offset,
            template_type=template_type,
            worker=worker,
        )
        return await self._aget_instances_2_oapg(
    ...
    def get_instances_2(
        ...
        return self._get_instances_2_oapg(
            query_params=args.query,
        )

class GetInstances2(BaseApi):
    ...
    async def aget_instances_2(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_instances_2(
            limit=limit,
            offset=offset,
            template_type=template_type,
            worker=worker,
    ...
    def get_instances_2(
        ...
        raw_response = self.raw.get_instances_2(
            limit=limit,
            offset=offset,
            template_type=template_type,
            worker=worker,
