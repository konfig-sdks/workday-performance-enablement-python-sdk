...
class GetInstanceRaw(BaseApi):
    ...
    async def aget_instance(
        ...
        **kwargs,
        ...
        args = self._get_instance_mapped_args(
            id=id,
        )
        return await self._aget_instance_oapg(
...
class GetInstance(BaseApi):
    ...
    async def aget_instance(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_instance(
            id=id,
            **kwargs,
        )
        if validate:
    ...
    def get_instance(
        ...
        raw_response = self.raw.get_instance(
            id=id,
        )
        if validate:
            return RootModel[GiveRequestedFeedbackDetailsD396fd5bffec10000e3eba1a70440000Pydantic](raw_response.body).root
