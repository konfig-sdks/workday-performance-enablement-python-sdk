...
SchemaFor200ResponseBodyApplicationJson = RequestedFeedbackOnSelfEventDetail19acce0101b310002e6bf03e1bbc0000Schema
...
class BaseApi(api_client.Api):
    ...
    def _get_self_requested_feedback_event_mapped_args(
        self,
        id: str,
        subresource_id: str,
    ...
    async def _aget_self_requested_feedback_event_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/workers/{ID}/requestedFeedbackOnSelfEvents/{subresourceID}',
            headers=_headers,
        )
    ...
    def _get_self_requested_feedback_event_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class GetSelfRequestedFeedbackEventRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_self_requested_feedback_event(
        self,
        id: str,
        subresource_id: str,
        **kwargs,
        ...
        args = self._get_self_requested_feedback_event_mapped_args(
            id=id,
            subresource_id=subresource_id,
        )
        return await self._aget_self_requested_feedback_event_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def get_self_requested_feedback_event(
        self,
        id: str,
        subresource_id: str,
    ) -> typing.Union[
        ...
        return self._get_self_requested_feedback_event_oapg(
            path_params=args.path,
        )

class GetSelfRequestedFeedbackEvent(BaseApi):
    ...
    async def aget_self_requested_feedback_event(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_self_requested_feedback_event(
            id=id,
            subresource_id=subresource_id,
            **kwargs,
        )
    ...
    def get_self_requested_feedback_event(
        ...
        raw_response = self.raw.get_self_requested_feedback_event(
            id=id,
            subresource_id=subresource_id,
        )
        if validate:
