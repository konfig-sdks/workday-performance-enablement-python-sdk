...
SchemaFor200ResponseBodyApplicationJson = FeedbackEventDetailAfd6ac52d62510001086b5c85cd50000Schema
...
class BaseApi(api_client.Api):
    ...
    def _get_feedback_event_mapped_args(
        self,
        id: str,
        subresource_id: str,
    ...
    async def _aget_feedback_event_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/workers/{ID}/anytimeFeedbackEvents/{subresourceID}',
            headers=_headers,
        )
...
class GetFeedbackEventRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_feedback_event(
        self,
        id: str,
        subresource_id: str,
        **kwargs,
        ...
        args = self._get_feedback_event_mapped_args(
            id=id,
            subresource_id=subresource_id,
        )
        return await self._aget_feedback_event_oapg(
    ...
    def get_feedback_event(
        ...
        return self._get_feedback_event_oapg(
            path_params=args.path,
        )

class GetFeedbackEvent(BaseApi):
    ...
    async def aget_feedback_event(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_feedback_event(
            id=id,
            subresource_id=subresource_id,
            **kwargs,
        )
    ...
    def get_feedback_event(
        ...
        raw_response = self.raw.get_feedback_event(
            id=id,
            subresource_id=subresource_id,
        )
        if validate:
