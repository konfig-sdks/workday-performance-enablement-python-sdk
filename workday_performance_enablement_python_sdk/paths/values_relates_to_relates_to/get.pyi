...
from workday_performance_enablement_python_sdk.model.multipleinstancemodelreference import MULTIPLEINSTANCEMODELREFERENCE as MULTIPLEINSTANCEMODELREFERENCESchema
...
from workday_performance_enablement_python_sdk.type.multipleinstancemodelreference import MULTIPLEINSTANCEMODELREFERENCE
...
from workday_performance_enablement_python_sdk.pydantic.multipleinstancemodelreference import MULTIPLEINSTANCEMODELREFERENCE as MULTIPLEINSTANCEMODELREFERENCEPydantic
...
RelatesToTagSchema = schemas.StrSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    'RequestOptionalQueryParams',
    {
        ...
        'relatesToTag': typing.Union[RelatesToTagSchema, str, ],
    },
    total=False
)
...
request_query_relates_to_tag = api_client.QueryParameter(
    name="relatesToTag",
    style=api_client.ParameterStyle.FORM,
    schema=RelatesToTagSchema,
    explode=True,
)
...
class BaseApi(api_client.Api):
    ...
    def _get_instances_3_mapped_args(
        self,
        limit: typing.Optional[int] = None,
        offset: typing.Optional[int] = None,
        relates_to_tag: typing.Optional[str] = None,
        ...
        if relates_to_tag is not None:
            _query_params["relatesToTag"] = relates_to_tag
        args.query = _query_params
        return args

    async def _aget_instances_3_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/values/relatesTo/relatesTo',
            headers=_headers,
        )
...
class GetInstances3Raw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_instances_3(
        self,
        limit: typing.Optional[int] = None,
        offset: typing.Optional[int] = None,
        relates_to_tag: typing.Optional[str] = None,
        **kwargs,
        ...
        args = self._get_instances_3_mapped_args(
            limit=limit,
            offset=offset,
            relates_to_tag=relates_to_tag,
        )
        return await self._aget_instances_3_oapg(
    ...
    def get_instances_3(
        ...
        return self._get_instances_3_oapg(
            query_params=args.query,
        )

class GetInstances3(BaseApi):
    ...
    async def aget_instances_3(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_instances_3(
            limit=limit,
            offset=offset,
            relates_to_tag=relates_to_tag,
            **kwargs,
    ...
    def get_instances_3(
        ...
        raw_response = self.raw.get_instances_3(
            limit=limit,
            offset=offset,
            relates_to_tag=relates_to_tag,
        )
