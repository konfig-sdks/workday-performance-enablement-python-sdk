...
from workday_performance_enablement_python_sdk.model.workers_get_goals_response import WorkersGetGoalsResponse as WorkersGetGoalsResponseSchema
...
from workday_performance_enablement_python_sdk.type.workers_get_goals_response import WorkersGetGoalsResponse
...
from workday_performance_enablement_python_sdk.pydantic.workers_get_goals_response import WorkersGetGoalsResponse as WorkersGetGoalsResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = WorkersGetGoalsResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: WorkersGetGoalsResponse
    ...
    async def _aget_goals_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/workers/{ID}/goals',
            headers=_headers,
        )
...
class GetGoalsRaw(BaseApi):
    ...
    async def aget_goals(
        ...
        **kwargs,
        ...
        args = self._get_goals_mapped_args(
            id=id,
            limit=limit,
            offset=offset,
        )
        return await self._aget_goals_oapg(
...
class GetGoals(BaseApi):
    ...
    async def aget_goals(
        ...
        validate: bool = False,
        **kwargs,
    ) -> WorkersGetGoalsResponsePydantic:
        raw_response = await self.raw.aget_goals(
            id=id,
            limit=limit,
            offset=offset,
            **kwargs,
        ...
        if validate:
            return WorkersGetGoalsResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(WorkersGetGoalsResponsePydantic, raw_response.body)
    ...
    def get_goals(
        ...
        raw_response = self.raw.get_goals(
            id=id,
            limit=limit,
            offset=offset,
        )
