...
class BaseApi(api_client.Api):
    ...
    def _get_instances_1_mapped_args(
        self,
    ...
    async def _aget_instances_1_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/values/feedbackOnWorker/feedbackOnWorker',
            headers=_headers,
        )
...
class GetInstances1Raw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_instances_1(
        self,
        limit: typing.Optional[int] = None,
        offset: typing.Optional[int] = None,
        **kwargs,
        ...
        args = self._get_instances_1_mapped_args(
            limit=limit,
            offset=offset,
        )
        return await self._aget_instances_1_oapg(
    ...
    def get_instances_1(
        ...
        return self._get_instances_1_oapg(
            query_params=args.query,
        )

class GetInstances1(BaseApi):
    ...
    async def aget_instances_1(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_instances_1(
            limit=limit,
            offset=offset,
            **kwargs,
        )
    ...
    def get_instances_1(
        ...
        raw_response = self.raw.get_instances_1(
            limit=limit,
            offset=offset,
        )
        if validate:
