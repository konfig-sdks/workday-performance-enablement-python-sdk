...
from workday_performance_enablement_python_sdk.model.goals_summary2c793e888bcd100033e663075a2b0000 import GoalsSummary2c793e888bcd100033e663075a2b0000 as GoalsSummary2c793e888bcd100033e663075a2b0000Schema
...
from workday_performance_enablement_python_sdk.pydantic.goals_summary2c793e888bcd100033e663075a2b0000 import GoalsSummary2c793e888bcd100033e663075a2b0000 as GoalsSummary2c793e888bcd100033e663075a2b0000Pydantic
...
SchemaFor200ResponseBodyApplicationJson = GoalsSummary2c793e888bcd100033e663075a2b0000Schema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: GoalsSummary2c793e888bcd100033e663075a2b0000
...
class BaseApi(api_client.Api):
    ...
    def _get_single_goal_mapped_args(
        self,
        id: str,
        subresource_id: str,
    ...
    async def _aget_single_goal_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/workers/{ID}/goals/{subresourceID}',
            headers=_headers,
        )
...
class GetSingleGoalRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_single_goal(
        self,
        id: str,
        subresource_id: str,
        **kwargs,
        ...
        args = self._get_single_goal_mapped_args(
            id=id,
            subresource_id=subresource_id,
        )
        return await self._aget_single_goal_oapg(
    ...
    def get_single_goal(
        ...
        return self._get_single_goal_oapg(
            path_params=args.path,
        )

class GetSingleGoal(BaseApi):
    ...
    async def aget_single_goal(
        ...
        validate: bool = False,
        **kwargs,
    ) -> GoalsSummary2c793e888bcd100033e663075a2b0000Pydantic:
        raw_response = await self.raw.aget_single_goal(
            id=id,
            subresource_id=subresource_id,
            **kwargs,
        )
        if validate:
            return RootModel[GoalsSummary2c793e888bcd100033e663075a2b0000Pydantic](raw_response.body).root
        return api_client.construct_model_instance(GoalsSummary2c793e888bcd100033e663075a2b0000Pydantic, raw_response.body)
    ...
    def get_single_goal(
        ...
        raw_response = self.raw.get_single_goal(
            id=id,
            subresource_id=subresource_id,
        )
        if validate:
