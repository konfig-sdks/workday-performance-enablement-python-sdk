...
from workday_performance_enablement_python_sdk.model.feedback_badges_get_collection_response import FeedbackBadgesGetCollectionResponse as FeedbackBadgesGetCollectionResponseSchema
...
from workday_performance_enablement_python_sdk.type.feedback_badges_get_collection_response import FeedbackBadgesGetCollectionResponse
...
from workday_performance_enablement_python_sdk.pydantic.feedback_badges_get_collection_response import FeedbackBadgesGetCollectionResponse as FeedbackBadgesGetCollectionResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = FeedbackBadgesGetCollectionResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: FeedbackBadgesGetCollectionResponse
...
class BaseApi(api_client.Api):
    ...
    def _get_collection_mapped_args(
        self,
    ...
    async def _aget_collection_oapg(
        self,
...
class GetCollectionRaw(BaseApi):
    ...
    async def aget_collection(
        ...
        **kwargs,
        ...
        args = self._get_collection_mapped_args(
            limit=limit,
            offset=offset,
        )
        return await self._aget_collection_oapg(
...
class GetCollection(BaseApi):
    ...
    async def aget_collection(
        ...
        validate: bool = False,
        **kwargs,
    ) -> FeedbackBadgesGetCollectionResponsePydantic:
        raw_response = await self.raw.aget_collection(
            limit=limit,
            offset=offset,
            **kwargs,
        )
        if validate:
            return FeedbackBadgesGetCollectionResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(FeedbackBadgesGetCollectionResponsePydantic, raw_response.body)
    ...
    def get_collection(
        ...
        raw_response = self.raw.get_collection(
            limit=limit,
            offset=offset,
        )
        if validate:
