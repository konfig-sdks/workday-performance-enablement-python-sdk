...
SchemaFor200ResponseBodyApplicationJson = RequestedFeedbackOnWorkerEventDetail2b4c8a6ca069100035b8586e16c20000Schema
...
class BaseApi(api_client.Api):
    ...
    def _get_requested_event_mapped_args(
        self,
        id: str,
        subresource_id: str,
    ...
    async def _aget_requested_event_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/workers/{ID}/requestedFeedbackOnWorkerEvents/{subresourceID}',
            headers=_headers,
        )
...
class GetRequestedEventRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_requested_event(
        self,
        id: str,
        subresource_id: str,
        **kwargs,
        ...
        args = self._get_requested_event_mapped_args(
            id=id,
            subresource_id=subresource_id,
        )
        return await self._aget_requested_event_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def get_requested_event(
        self,
        id: str,
        subresource_id: str,
    ) -> typing.Union[
        ...
        return self._get_requested_event_oapg(
            path_params=args.path,
        )

class GetRequestedEvent(BaseApi):
    ...
    async def aget_requested_event(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_requested_event(
            id=id,
            subresource_id=subresource_id,
            **kwargs,
        )
    ...
    def get_requested_event(
        ...
        raw_response = self.raw.get_requested_event(
            id=id,
            subresource_id=subresource_id,
        )
        if validate:
