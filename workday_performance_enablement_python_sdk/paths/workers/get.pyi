...
from workday_performance_enablement_python_sdk.model.workers_get_collection_staffing_response import WorkersGetCollectionStaffingResponse as WorkersGetCollectionStaffingResponseSchema
...
from workday_performance_enablement_python_sdk.type.workers_get_collection_staffing_response import WorkersGetCollectionStaffingResponse
...
from workday_performance_enablement_python_sdk.pydantic.workers_get_collection_staffing_response import WorkersGetCollectionStaffingResponse as WorkersGetCollectionStaffingResponsePydantic
...
# Query params
IncludeTerminatedWorkersSchema = schemas.BoolSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    ...
    {
        'includeTerminatedWorkers': typing.Union[IncludeTerminatedWorkersSchema, bool, ],
...
request_query_include_terminated_workers = api_client.QueryParameter(
    name="includeTerminatedWorkers",
    style=api_client.ParameterStyle.FORM,
    schema=IncludeTerminatedWorkersSchema,
    explode=True,
)
...
SchemaFor200ResponseBodyApplicationJson = WorkersGetCollectionStaffingResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: WorkersGetCollectionStaffingResponse
...
class BaseApi(api_client.Api):
    ...
    def _get_collection_staffing_mapped_args(
        self,
        include_terminated_workers: typing.Optional[bool] = None,
        ...
        _query_params = {}
        if include_terminated_workers is not None:
            _query_params["includeTerminatedWorkers"] = include_terminated_workers
    ...
    async def _aget_collection_staffing_oapg(
        self,
        ...
        **kwargs,
        ...
        for parameter in (
            request_query_include_terminated_workers,
            request_query_limit,
    ...
    def _get_collection_staffing_oapg(
        self,
            query_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class GetCollectionStaffingRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_collection_staffing(
        self,
        include_terminated_workers: typing.Optional[bool] = None,
        limit: typing.Optional[int] = None,
        offset: typing.Optional[int] = None,
        ...
        **kwargs,
        ...
        args = self._get_collection_staffing_mapped_args(
            include_terminated_workers=include_terminated_workers,
            limit=limit,
            offset=offset,
            search=search,
        )
        return await self._aget_collection_staffing_oapg(
            query_params=args.query,
            **kwargs,
        )
    
    def get_collection_staffing(
        self,
        include_terminated_workers: typing.Optional[bool] = None,
        limit: typing.Optional[int] = None,
        offset: typing.Optional[int] = None,
        ...
        return self._get_collection_staffing_oapg(
            query_params=args.query,
        )

class GetCollectionStaffing(BaseApi):
    ...
    async def aget_collection_staffing(
        ...
        validate: bool = False,
        **kwargs,
    ) -> WorkersGetCollectionStaffingResponsePydantic:
        raw_response = await self.raw.aget_collection_staffing(
            include_terminated_workers=include_terminated_workers,
            limit=limit,
            offset=offset,
            search=search,
        ...
        if validate:
            return WorkersGetCollectionStaffingResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(WorkersGetCollectionStaffingResponsePydantic, raw_response.body)
    ...
    def get_collection_staffing(
        ...
        raw_response = self.raw.get_collection_staffing(
            include_terminated_workers=include_terminated_workers,
            limit=limit,
            offset=offset,
            search=search,
