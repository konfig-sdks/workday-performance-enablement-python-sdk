...
class RelatesToSummary2c793e888bcd100034b42ada01b20000(
    ...
    class MetaOapg:
        ...
        class all_of_0(
            ...
            def __getitem__(self, name: typing.Union[typing_extensions.Literal["type", "descriptor", "id", ], str]):
            ...
            def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["type", "descriptor", "id", ], str]):
