...
from workday_performance_enablement_python_sdk.paths.feedback_badges import get
from workday_performance_enablement_python_sdk import configuration, schemas, api_client

from .. import ApiTestMixin


class TestFeedbackBadges(ApiTestMixin, unittest.TestCase):
    """
    FeedbackBadges unit test stubs
